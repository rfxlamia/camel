...
# Camel Kanban
  ...
  A kanban board for small and growing teams, built around the six essential kanban
...
Camel Kanban is a full-stack, multi-user kanban board designed for small and growing teams. It combines drag-and-drop card management with real-time collaboration, flow metrics, WIP limit enforcement, and an agentic LLM pipeline for automated research and reporting.
