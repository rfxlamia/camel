...
const wsA = { id: 1, name: "WS-A", role: "member" as const, isPersonal: false, memberCount: 2 };
const wsB = { id: 2, name: "WS-B", role: "admin" as const, isPersonal: false, memberCount: 3 };
const personal = { id: 3, name: "Nina's Workspace", role: "owner" as const, isPersonal: true, memberCount: 1 };
