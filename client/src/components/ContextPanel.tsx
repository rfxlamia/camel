...
function DetailsSection({
  ...
  const save = async () => {
    ...
    if (result === "saved") {
      baselineRef.current = { ...baselineRef.current, title: trimmed, description };
      setTitle(trimmed);
...
export default function ContextPanel() {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-30 overscroll-none" onClick={close} aria-hidden />
      <aside
        role="dialog"
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
          ...
          {toolTrace && toolTrace.length > 0 && (
            <section aria-label="Tool Trace" className="border-t border-neutral-200 px-4 py-4">
              <h3 className="text-sm font-semibold uppercase tracking-wide text-neutral-600">
                Tool Activity
              </h3>
              <div className="mt-3">
