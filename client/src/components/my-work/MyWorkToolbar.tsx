...
function controlClass(): string {
	return "h-9 rounded-md border border-neutral-300 bg-white px-2.5 text-sm text-neutral-800 shadow-sm outline-none transition-colors motion-reduce:transition-none hover:border-neutral-400 focus:border-primary-600 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-primary-600";
}
