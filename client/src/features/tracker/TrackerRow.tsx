...
import { formatDueDate, isDueOverdue } from "../../shared/boardViewUtils";
...
import { useTrackerRowOpenPicker } from "./useTrackerRowOpenPicker";
...
export default function TrackerRow({
	...
	const { openPicker, requestPicker, datePopoverRef, kebabRef } =
	...
	const statusOptions = buildTrackerRowStatusOptions(statuses, item.status.id);
