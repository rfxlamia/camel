...
export default function EmailGatePage({ user }: Props) {
			...
			<div className="w-full max-w-sm">
				...
				<div className="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm">
					...
					<p className="mt-1 text-sm text-neutral-600">
						Hi {user.displayName}! To keep your account secure, we need you to
						link a social provider. This verifies your email address.
					</p>
