...
describe("Cycle C — one-way vs kernel allowlist (unit)", () => {
	...
	const extractedKernel = [
		...
		{
			file: "server/src/modules/board/x.ts",
			spec: `import { c } from "../../routes/card-response.js";\n`,
		},
		{
			file: "server/src/modules/my-work/x.ts",
			spec: `import { a } from "../../routes/card-assignees.js";\n`,
		},
		{
			file: "server/src/modules/board/x.ts",
		...
		{
			file: "client/src/features/board/x.ts",
			spec: `import { p } from "../../components/tracker/TrackerPropertyPicker.tsx";\n`,
		},
		{
			file: "client/src/features/board/x.ts",
			spec: `import { b } from "../../lib/boardViewUtils.ts";\n`,
		},
		{
			file: "client/src/features/board/x.ts",
